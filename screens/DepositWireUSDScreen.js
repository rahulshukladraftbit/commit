...
const DepositWireUSDScreen = props => {
  ...
  const [bankName, setBankName] = React.useState('Crossriver');
...
export default withTheme(DepositWireUSDScreen);
